...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      <body className={`${inter.className} bg-slate-950 text-slate-100 antialiased min-h-screen flex flex-col`} suppressHydrationWarning>
        {/* Navbar */}
        ...
        {/* Footer */}
        <footer className="border-t border-slate-900 py-8 mt-auto">
