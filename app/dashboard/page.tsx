            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              ...
              {isDriveConnected ? (
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-red-50 border border-red-200 hover:bg-red-100 text-red-700 font-medium rounded-lg transition-colors"
                >
